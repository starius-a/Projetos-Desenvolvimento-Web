...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-light navbar-dark bg-dark">
  ...
  <div class="row">
    <form class="row g-3 formulario" name = "excluir_usuario.php" action="excluir_usuario.php" method = "POST">
      ...
      <div class="col-12 col-md-12 col-lg-12">
       ...
       <div class="col-12 col-md-12 col-lg-12"> 
        <button type="submit" class="btn btn-primary" name="btnExcluirUsuario">Excluir</button>
