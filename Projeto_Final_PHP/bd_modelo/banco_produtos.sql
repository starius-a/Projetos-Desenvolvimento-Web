...
CREATE TABLE `produtos` (
  ...
  CONSTRAINT `produtos_ibfk_1` FOREIGN KEY (`id_fornecedores`) REFERENCES `fornecedores` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `produtos_categorias` (
  ...
  CONSTRAINT `produtos_categorias_ibfk_1` FOREIGN KEY (`id_produtos`) REFERENCES `produtos` (`id`),
  CONSTRAINT `produtos_categorias_ibfk_2` FOREIGN KEY (`id_categorias`) REFERENCES `categorias` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-10-23 14:13:46
