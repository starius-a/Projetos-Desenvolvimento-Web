    ...
    <form action="cadastrar_prefeitura.php" name="cadastrar_prefeitura.php" id="cadastrar_prefeitura.php" method = "POST"> 
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="nome_municipio" id="nome_municipio" placeholder = ""></td>
            </tr>
            <tr>
                <td>Unidade Federativa: </td>
                <td><input type="text" name = "uf" id = "uf" placeholder = ""></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name = "aniversario_municipal" id = "aniversario_municipal" placeholder = "AAAA-MM-DD"></td>
            </tr>
            <tr>
