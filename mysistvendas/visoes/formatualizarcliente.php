<?php
	...
	if(isset($_GET['idCliente'])){
   	...
   	if(isset($_POST['btatualizar'])){
    	...
    	$msg = atualizarCliente($idCliente, $cpf, $nome, $dataNascimento, $sexo, $endereco);
   }
 ...
 <html>
	<body>
		<form action="formatualizarcliente.php" name="formAtualizarCliente" 
		id="formAtualizarCliente" method="POST">
		...
		<table>
			...
			<tr>
				<td colspan="2"><h2>Atualizar Cliente</h2> </td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center">
					<input type="submit" name="btatualizar" value="Cadastrar" >
				</td>
			</tr>
		</table>
		</form>
