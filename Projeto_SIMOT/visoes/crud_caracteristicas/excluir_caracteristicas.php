<?PHP
    ...
    if(isset($_POST["btnExcluirCaracteristicas"])){
        ...
        $msg = excluirCaracteristicas($fkid_municipios);
...
<body>
<form action="excluir_caracteristicas.php" id = "excluirCaracteristicas" method = "POST">
