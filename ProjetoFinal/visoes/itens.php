...
<html>
  ...
  <br>
    ...
    <div class="row">
      <div class="col-12 col-md-12 col-lg-12">
       <h2>Cursos Disponibilizados</h2><button class="btn btn-outline-primary">Cadastrar curso</button>
    </div>
     </div>
    ...
    <tr>
      ...
      <td><button  class="btn btn-primary">Lista</button></td>
      <td><div class="d-grid gap-2 d-md-block"><button  class="btn btn-secondary">Editar</button> <button  class="btn btn-danger">Excluir</button></div></td>
    </tr>
    <tr>
