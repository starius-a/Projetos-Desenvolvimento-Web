<?PHP
    ...
    if(isset($_POST["btnExcluirOrgao"])){
        ...
        $msg = excluirOrgao($fkid_municipios);

        header('location: consultar_orgaos.php');
        die();
...
<body>
    ...
    <form action="excluir_orgao.php" method="POST">
        <table>
            <tr>
                <td><a href="../crud_prefeituras/acessar_prefeitura.php">Voltar</a></td>
            </tr>
            <tr>
                <td>Excluir Órgão Oficial do Turismo</td>
            </tr>
            <tr>
            ...
            <tr>
                <td> Email</td>
                <td> <input type="text" name="site" id="site" value=<?PHP echo "$email"?>></td>
            </tr>
            <tr>
                <td> Site</td>
                <td> <input type="text" name="email" id="email" value=<?PHP echo "$site"?>></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><input type="submit" name="btnExcluirOrgao" value="Excluir"></td>
            </tr>
