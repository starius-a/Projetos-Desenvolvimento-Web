CREATE DATABASE  IF NOT EXISTS `bdsimot` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `bdsimot`;
...
INSERT INTO `infobas_municipios` VALUES (11,'Goianinha','RN','Barra de Cunhaú','Rua Fulano de Tal',13,'Prédio','Matadouro',NULL,'goianinharn12@gmail.com','','98987987',87676,5654,5365,58,998,'Nira','1832-08-07','Nossa Senhora dos Prazeres'),(12,'Município','RN','Região tal','Rua Fulano de Tal',10,'','Bairro Irineu',NULL,'prefeiturarn@gmail.com','','000000',0,0,0,1,1,'Beltrano','2021-11-12','Santo(a) tal');
...
CREATE TABLE `servicos_comunicacao` (
  ...
  `area_todo_municipio_tmovel` tinyint(1) DEFAULT NULL,
  `area_parte_municipio_tmovel` tinyint(1) DEFAULT NULL,
  `telefonia_fixa` tinyint(1) NOT NULL,
  `area_todo_municipio_tfixa` tinyint(1) DEFAULT NULL,
  `area_parte_municipio_tfixa` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`fkid_municipios`),
...
-- Dump completed on 2022-03-08  9:26:47
