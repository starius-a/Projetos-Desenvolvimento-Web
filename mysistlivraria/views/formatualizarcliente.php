<?php
    ...
    if(isset($_POST['btatualizar'])){
    	$msg = editarClientes($cpf, $nome, $email, $data_nascimento, $idade);
   }
...
<html>
    <body>
        <table>
            <form action = "formatualizarcliente.php" name = "Cadastrar_Cliente" id = "Cadastrar_Cliente"
            method = "POST">
                <tr>
				...
				<td colspan="2" align="justify">
					<?php 
						echo "<input type=\"submit\" name=\"btatualizar\" value=\"Atualizar\" >";
					?>
				</td>
