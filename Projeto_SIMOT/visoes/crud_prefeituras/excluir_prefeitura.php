...
include "../../controles/controlar_prefeituras.php";
    ...
    if(isset($_POST["btnExcluir"])) {
        ...
        $msg = excluirPrefeitura($id_municipios);
...
<body>
<form action="excluir_prefeitura.php" name="excluir_prefeitura.php" id="excluir_prefeitura.php" method = "POST"> 
    
    <table>
        <tr>
            <td colspan = "2"><a href="\Projeto_SIMOT\index.php"> Voltar </a></td>
        </tr>
        <tr>
            <td colspan = "2"> <h2>Excluir prefeitura</h2></td>
        </tr>
        <tr>
            <td>Identificador</td>
