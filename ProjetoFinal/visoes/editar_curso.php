<?PHP
  ...
  if(isset($_POST["btnAtualizarItem"])){
  ...
  if(isset($_FILES['imagem_curso']) && !empty($_FILES["imagem_curso"]["name"])){
    ...
    $sql = "UPDATE bdcursos.curso SET 
    nome = '$nome',
    carga_horaria = '$carga_horaria',
    descricao = '$descricao',
    ano = '$ano', imagens='$nome_imagem' WHERE id_curso = '$id_curso';";
  } else {
    $sql = "UPDATE bdcursos.curso SET 
            nome = '$nome',
            carga_horaria = '$carga_horaria',
            descricao = '$descricao',
            ano = '$ano' WHERE id_curso = '$id_curso';";
  }
...
<html>
  ...
  <div class="container-fluid">
    ...
    <div class="col-sm-3 col-md-3 mb-4">
      <p class="text-center"> 
        <a href="cadastroitem.php" class="btn btn-outline-dark btn-custom">Atualizar curso</a>
       </p>
    </div>
  </div>
  <br>
   ...
   <div class="row">
     <form class="row g-3 formulario" name = "editar_curso.php" action="editar_curso.php" method="POST" enctype="multipart/form-data">
       ...
       <div class=" col-lg-12 col-12 col-md-12">
         ...
         <div class="col-lg-12 col-12 col-md-12">
          <label for="exampleFormControlInput1"  class="form-label">Imagem Atual:</label>
          <p><img src="../imagens/<?PHP echo $imagem;?>" width = "250px" height = "200px" alt="Imagem de <?PHP echo $nome;?>" ></p>
         </div>

         <div class=" col-lg-12 col-12 col-md-12">
          <label for="exampleFormControlInput1"  class="form-label">Selecione uma nova imagem:</label>
        ...
        <div class=" col-lg-12 col-12 col-md-12">
         ...
         <div class="col-12 col-md-12 col-lg-12">
          ...
          <textarea class="form-control" id="exampleFormControlTextarea1"   name="descricao"  value=<?PHP echo "$descricao"?>></textarea>
          </div>
        ...
        <div class="col-12 col-md-12 col-lg-12">
         ...
         <div class="col-12 col-md-12 col-lg-12"> 
          <button type="submit" class="btn btn-primary" name="btnAtualizarItem">Atualizar</button>
         </div>
      </form>     
    </div>
